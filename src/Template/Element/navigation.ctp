...
<nav class="navbar navbar-ffbe">
    <div class="container-fluid">
        <ul class="nav navbar-nav">
            ...
            <li <?= ($this->request->controller === 'Units' && $this->request->action === 'closestToLevel') ? 'class="active"' : ''?>>
                <?= $this->Html->link('Closest to awaken or max', ['controller' => 'Units', 'action' => 'closestToLevel'])?>
            </li>
        </ul>
